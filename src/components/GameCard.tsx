...
const GameCard = ({ game, variant = "default", index = 0 }: GameCardProps) => {
  if (variant === "featured") {
    return (
      <motion.div
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4">
          {game.isNew && (
            <span className="mb-2 inline-block rounded-full bg-primary px-2.5 py-0.5 text-xs font-bold text-primary-foreground">
              NEW
            </span>
          )}
  ...
  return (
    <motion.div
      ...
      className="glass-card group overflow-hidden rounded-xl transition-all hover:border-glow"
    >
